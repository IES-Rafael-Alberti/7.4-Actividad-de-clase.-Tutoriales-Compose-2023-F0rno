package es.edu.iesra.daw.pfp.compose.image.loadingImagesFromDeviceStorageOrNetwork
...
fun main() = singleWindowApplication {
    ...
    Column {
        AsyncImage(
            load = { loadImageBitmap(File("src/jvmMain/kotlin/es/edu/iesra/daw/pfp/compose/image/loadingImagesFromDeviceStorageOrNetwork/sample.png")) },
        ...
        AsyncImage(
            load = { loadXmlImageVector(File("src/jvmMain/kotlin/es/edu/iesra/daw/pfp/compose/image/loadingImagesFromDeviceStorageOrNetwork/compose-logo.xml"), density) },
